...
// Input graph edges
        adj_list.get(0).add(new Node(1, 3));
        adj_list.get(0).add(new Node(3, 8));
        adj_list.get(0).add(new Node(4, 7));
        adj_list.get(1).add(new Node(2, 1));
        adj_list.get(1).add(new Node(3, 4));
        adj_list.get(3).add(new Node(2, 2));
        adj_list.get(4).add(new Node(3, 3));
        adj_list.get(1).add(new Node(0, 3));
        adj_list.get(3).add(new Node(0, 8));
        adj_list.get(4).add(new Node(0, 7));
        adj_list.get(2).add(new Node(1, 1));
        adj_list.get(3).add(new Node(1, 4));
        adj_list.get(2).add(new Node(3, 2));
        adj_list.get(3).add(new Node(4, 3));
